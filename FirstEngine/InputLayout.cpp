...
InputLayout::InputLayout(ID3D11Device* device, ID3DBlob* pVertexShaderBytecode) {
...
InputLayout::InputLayout(ID3D11Device* device, const std::vector<D3D11_INPUT_ELEMENT_DESC>& layout, ID3DBlob* pVertexShaderBytecode) {
...
void InputLayout::Bind(ID3D11DeviceContext* deviceContext) noexcept {
