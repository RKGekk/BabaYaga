...
const EventTypeId& EvtData_Move_Actor::VGetEventType() const {
    return sk_EventType;
}
...
const std::string& EvtData_Move_Actor::GetName(void) const {
    return sk_EventName;
}
...
const DirectX::XMFLOAT4X4& EvtData_Move_Actor::GetMatrix() const {
    return m_matrix;
}
